      ...
      <div >
        ...
        <div className="flex justify-evenly h-full">
          ...
          <div className="border-2">
            <img src={productID.image} alt="" className="w-[316px]" />
          </div>
          {/* PRODUCT DATA */}
          <div className="flex flex-col justify-evenly">
            {/* TITLE */}
            <div>
                <Typography varient='h3' style='font-semibold'>{productID.title}</Typography></div>
            {/* STAR & REVIEWS */}
            <div className="flex w-full justify-evenly items-center">
              ...
              <div>
                <Typography varient="small" style='text-[#33A0FF]'>Submit a review</Typography>
              </div>
            </div>
            {/* PRICES */}
            <div className="flex justify-between items-center">
              <div className="flex gap-2">
                <Typography varient="h6" style='text-[#33A0FF] font-bold'>{productID.currency} {productID.price}</Typography>
                <Typography varient="small" effect='muted'>{productID.currency} {productID.oldPrice}</Typography>
              </div>
            ...
            <div>
              <Typography varient="p">
                Availability: {productID.availability}
              </Typography>
            </div>
            {/* CATEGORY */}
            <div>
            ...
            {/* SHIPPING */}
            <div>
              <Typography varient="p">{productID.shipping}</Typography>
            </div>
            ...
            <div className=" flex">
              ...
              <div className="flex  h-[42px]">
                <Btn
                  variant="white"
                  onClick={() => setNum((prev) => Number(prev) > 0 ? prev - 1 : 0)}
